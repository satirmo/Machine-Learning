...
class StochasticGradientDescent:
    def __init__(self, training_data_file, training_parameters):
        ...
        self.stochastic_gradient_descent(training_parameters)
    ...
    def stochastic_gradient_descent(self, training_parameters):
        ...
        iteration = 0
        indexes = np.array([i for i in range(self.m)])
...
if __name__ == "__main__":
    ...
    STOCHASTIC_GRADIENT_DESCENT = StochasticGradientDescent(TRAINING_DATA_FILE, TRAINING_PARAMETERS)
    OUTPUT = STOCHASTIC_GRADIENT_DESCENT.evaluate_queries(QUERY_FILE)
